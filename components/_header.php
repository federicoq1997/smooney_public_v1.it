<header>
	<!-- 
		...
		||               Casa sono le braccia di chi,                 ||
		||quando ti stringe, ti fa sentire di essere nel posto giusto ||
		||                                                            ||
		||                        TI AMO                         ||
		||                                                            ||
		################################################################
	...
	<div class="row w-100 m-0">
			<div class="col px-0">
					<div class="row w-100 align-items-center justify-content-end position-relative">
												...
												<div class="hp-cursor-pointer rounded-4 border hp-border-color-dark-80">
														<div class="rounded-3 overflow-hidden m-4 d-flex">
																<div class="avatar-item hp-bg-info-4 d-flex" style="width: 32px; height: 32px;">
																		<img src="<?=SITEDOMAIN?>/assets/app-assets/img/users/<?=!empty($USERDATA['Gender'])?'user-3.svg':'user-8.svg'?>">
																</div>
														</div>
												</div>

												<div class="hp-header-profile-menu dropdown-fade position-absolute pt-18" style="top: 100%; width: 260px;">
														<div class="rounded hp-bg-black-0 hp-bg-dark-100 px-18 py-24 shadow">
																<div class="row">
																		<div class="col-12">
																				<a class="hp-p1-body fw-medium" href="<?=SITEDOMAIN?>/profile"><?=io::_('View Profile')?></a>
																		</div>

																		<div class="col-12 mt-24">
																				<span class="hp-p1-body fw-medium help-driverjs " style="cursor: pointer;" ><?=io::_('Help')?></span>
																		</div>

																		<div class="col-12 mt-24">
																				<a class="hp-p1-body fw-medium" href="<?=SITEDOMAIN?>/logout"><?=io::_('Logout')?></a>
																		</div>
																</div>
														</div>
												</div>
...
<?php require_once(dirname(__FILE__).'/sidebar/_sidebar_mobile.php'); ?>
<?php io::w(); ?>