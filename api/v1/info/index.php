...
<body>
  <h1 style="color: white; z-index: 10000; position: sticky; font-family: 'Nunito', sans-serif; letter-spacing: 5px;">
		<img class="hp-logo hp-sidebar-visible hp-dark-none" 
			src="<?=SITEDOMAIN?>/assets/app-assets/img/SmooneyLogo/smooney.logo-white.svg" 
			alt="logo" style="max-height: 70px; position: absolute; left: 50%; transform: translateX(-50%); ">
	</h1>
  <canvas id="c" width="1086" height="824"></canvas>
    ...
    <script>var w = c.width = window.innerWidth,
		...
		ctx.fillText( 'Smooney', w / 2 - ctx.measureText( 'Smooney' ).width / 2, h / 2 - 15 );
